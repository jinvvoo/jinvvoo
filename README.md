...
|:---|:---|:---|:---:|:---:|:---:|:---:|
| **QInvest** | 미국 시장 데이터와 관심 종목을 분석해 리포트와 시장 브리핑을 웹·메신저로 제공하는 서비스 | TypeScript, JavaScript, React, Next.js<br>Node.js, Express, SQLite, PM2 | ![Team](https://img.shields.io/badge/Team-red) | 2026.02 ~<br>진행 중 | 👉<br>[Repo](https://github.com/jinvvoo/project-portfolio/tree/main/qinvest) | 개발 중 |
| **KeySift** | 사진·영상·오디오를 미리보고 지정 폴더로 안전하게 분류하는 Windows 도구 | C#, .NET 8, WPF<br>FFmpeg | ![Personal](https://img.shields.io/badge/Personal-0F766E) | 2026.05 ~<br>진행 중 | 👉<br>[Repo](https://github.com/jinvvoo/project-portfolio/tree/main/keysift) | v0.11.1<br>공개 |
...
| **CNN 마스크 착용 감지** | 실시간 영상의 착용 상태를 분류하고 현장 경고·원격 모니터링으로 연결한 졸업작품 | Python, Keras, OpenCV<br>Pillow, Raspberry Pi | ![Team](https://img.shields.io/badge/Team-red) | 2021 | 👉<br>[Repo](https://github.com/jinvvoo/project-portfolio/tree/main/cnn-mask-detection) | 졸업논문 |
