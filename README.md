...
|:---|:---|:---|:---:|:---:|:---:|:---:|
| **QInvest** | 미국 시장 데이터와 관심 종목을 분석해 리포트와 시장 브리핑을 웹·메신저로 제공하는 서비스 | TypeScript, JavaScript, React, Next.js<br>Node.js, Express, SQLite, PM2 | ![Team](https://img.shields.io/badge/Team-red) | 2026.02 ~<br>진행 중 | 준비중 | 개발 중 |
