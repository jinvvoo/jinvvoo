...
| **우리가족섬** | 가족 유대감 형성을 위한 3D 메타버스 라이프로깅 SNS | Java, Spring Boot, Spring Security, JWT<br>JPA, MySQL, Redis<br>Swagger/OpenAPI, AWS EC2 | ![Team](https://img.shields.io/badge/Team-red) | 2023.10 ~<br>12 | 👉<br>[Repo](https://github.com/WooriIsland/back-end) | 🏆<br>과학기술 정보통신부 장관상 |
